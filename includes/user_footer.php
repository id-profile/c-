...
<footer class="bg-white border-t">
    <div class="max-w-6xl mx-auto px-6 py-6 text-sm text-slate-500 flex items-center justify-between">
        <span>© 2024 Pulse Community. Built for thoughtful conversations.</span>
        <span class="flex items-center gap-2"><i class="fa-solid fa-shield-halved text-indigo-500"></i> Secure • Real-time • Scalable</span>
    </div>
</footer>
...
<script src="https://cdn.jsdelivr.net/npm/nanostores@0.10.0/nanostores.iife.js"></script>
<script src="https://cdn.jsdelivr.net/npm/mitt@3.0.1/dist/mitt.umd.js"></script>
<script src="https://cdn.jsdelivr.net/npm/localforage@1.10.0/dist/localforage.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/workbox-window@7.0.0/build/workbox-window.prod.umd.js"></script>
<script src="https://cdn.jsdelivr.net/npm/jwt-decode@4.0.0/build/umd/index.min.js"></script>
